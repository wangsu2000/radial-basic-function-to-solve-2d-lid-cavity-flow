...
itermax = 200;
nitermax = 1;
Lambda = 0.00000001;%Tikhonov正则化参数
...
% col = 0.5*cos(pi*(2*N-1:-2:1)/2/N)+0.5;%Chebyshev点
lc = length(col);
...
vel_2u = [0 -0.18109 -0.20196 -0.2222 -0.2973 -0.38289 -0.27805 -0.10648 -0.06080 0.05702 0.18719 0.33304 0.46604 0.51117 0.57492 0.65928 1.0];
...
vel_1v = [0 0.27485 0.29012 0.30353 0.32627 0.37095 0.33075 0.32235 0.02526 -0.31966 -0.42665 -0.51550 -0.39188 -0.33714 -0.27669 -0.21388 0];
